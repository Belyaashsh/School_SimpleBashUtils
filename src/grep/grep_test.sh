...
COUNTER=0
DIFF_RES=""
TEST_FILE="you test1.txt"
TEST_FILE_F="-f pattern.txt test1.txt test2.txt"
TEST_FILE_E="-e q -e wing test1.txt"
TEST_FILE_E_F="-f pattern.txt -e feel test1.txt test2.txt"
